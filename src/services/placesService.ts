...
const PLACE_INDEX: IndexedPlace[] = [
  ...
  {
    label: 'Miami',
    sublabel: 'Florida · City',
    address: 'Downtown Miami, FL',
    kind: 'city',
    aliases: ['miami', 'south beach', 'mia'],
  },
  {
    label: 'Orlando',
    sublabel: 'Florida · City',
    ...
    kind: 'city',
    aliases: ['orlando', 'disney world', 'mco'],
  },
  {
    label: 'Atlanta',
    sublabel: 'Georgia · City',
  ...
  {
    label: 'Los Angeles',
    sublabel: 'California · City',
    address: 'Downtown Los Angeles, CA',
    kind: 'city',
    aliases: ['los angeles', 'la', 'hollywood', 'lax'],
  },
  {
    label: 'San Francisco',
    sublabel: 'California · City',
  ...
  {
    label: 'Las Vegas',
    sublabel: 'Nevada · City',
    address: 'The Strip, Las Vegas, NV',
    kind: 'city',
    aliases: ['las vegas', 'vegas', 'the strip'],
  },
  {
    label: 'Seattle',
    sublabel: 'Washington · City',
